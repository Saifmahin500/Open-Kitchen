        ...
        <div>
            ...
            <div className="hero min-h-screen" style={{ backgroundImage: 'url(https://i.ibb.co/F7Ycr3q/17821681-Food-Pattern-5-01.jpg)' }}>         
                ...
                <div className="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div>
                        <h1 className="text-xl font-bold">Best in Open Kitchen!</h1>
                        <p className="text-5xl font-bold py-6">Supper delicious <br /> <span className="text-[#d52a00]">Burger</span> in town! </p>
